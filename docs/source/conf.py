...
# -*- coding: utf-8 -*-
#
# cloudmesh.comet documentation build configuration file, created by
...
html_theme_options = {
    ...
    # an arbitrary url.
    'navbar_links': [
        ("CMD5", "https://github.com/cloudmesh/cloudmesh-cmd5/blob/master/README.md", True),
    ],
...
htmlhelp_basename = 'cloudmeshcometdoc'
