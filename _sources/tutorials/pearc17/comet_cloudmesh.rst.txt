...
.. prompt:: bash, (CM)$
  ...
  cms comet power off vctNN

Now we need to power on the server

.. prompt:: bash, (CM)$

  cms comet power on vctNN
...
.. prompt:: bash, (CM)$
   ...
   cms comet start vctNN vm-vctNN-[00-01]
...
.. prompt:: bash, (CM)$
    ...
    cms comet cluster vctNN --status
...
.. prompt:: bash, (CM)$
  ...
  cms comet power on vctNN vm-vctNN-[00-01]
